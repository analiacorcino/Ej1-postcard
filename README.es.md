...
💡 Importante: Para guardar el proyecto en github recuerda crear un nuevo repositorio, actualiza el remoto (`git remote set-url origin <https://github.com/analiacorcino/ejercicio-postcard.git>`), y guarda tu código en tu nuevo repositorio usando `add`, `commit` y `push`.
